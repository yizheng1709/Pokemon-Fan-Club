...
def get_page
    ...
    array.each do |pokemon|
        ...
        # binding.pry
        pk = Pokemon.create(name: name, types: types, weaknesses: weaknesses, abilities: abilities, description: description, image: image, category: category, height: height, weight: weight)
